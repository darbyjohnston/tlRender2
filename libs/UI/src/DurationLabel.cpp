...
namespace tl
{
    ...
    namespace ui
    {
        ...
        const core::MediaRate& DurationLabel::getRate() const
        {
            return _p->rate;
        }

        void DurationLabel::setRate(const core::MediaRate& value)
        {
            FTK_P();
            if (value == p.rate)
                return;
        ...
        void DurationLabel::setGeometry(const ftk::Box2I& value)
        {
