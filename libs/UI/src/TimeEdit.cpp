...
namespace tl
{
    ...
    namespace ui
    {
        struct TimeEdit::Private
        {
            ...
            MediaRate rate;
            Time value;
            std::function<void(const Time&)> callback;
        ...
        void TimeEdit::setValue(const Time& value)
        {
            FTK_P();
            if (value == p.value)
                return;
        ...
        void TimeEdit::setCallback(const std::function<void(const Time&)>& value)
        {
            _p->callback = value;
        }
        ...
        void TimeEdit::_commitValue(const Time& value)
        {
            FTK_P();
            p.value = value;
            _textUpdate();
